...
new_df['Embarked'] = emb_encoder.fit_transform(new_df['Embarked'])

sex_encoder = LabelEncoder()
new_df['Sex'] = sex_encoder.fit_transform(new_df['Sex'])

cabin_encoder = LabelEncoder()
new_df['Cabin'] = cabin_encoder.fit_transform(new_df['Cabin'])

with open("emb_encoder.pkl", "wb") as file:
  pickle.dump(emb_encoder, file)

with open("cabin_encoder.pkl", "wb") as file:
  pickle.dump(cabin_encoder, file)
...
# No need to scale x_test here, as it's not used for training
...
with open("emb_encoder.pkl", "rb") as file1:
    emb_encoder = pickle.load(file1)
with open("sex_encoder.pkl", "rb") as file2:
    sex_encoder = pickle.load(file2)
with open("cabin_encoder.pkl", "rb") as file3:
    cabin_encoder = pickle.load(file3)
...
if st.button("Predict"):
    ...
    input_data['Cabin'] = cabin_encoder.transform(input_data['Cabin'])
    input_data['Embarked'] = emb_encoder.transform(input_data['Embarked'])
