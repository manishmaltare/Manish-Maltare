"""Copy of Sentiment Analysis - Group 1.ipynb
...
import nltk
nltk.download('stopwords', download_dir='english_stopwords.txt')
import pandas as pd
import numpy as np
import string
...
# Load or rebuild your vocab and idf here; you must use the same vocab/idf as training
# For example, rebuild from training corpus or load from pickles if saved.
# This example assumes you have them loaded as `vocab` and `idf`
